...
public class Entity 
{
    ...
    public BufferedImage attackUp1, attackUp2, attackDown1, attackDown2, attackRight1, attackRight2,
    attackLeft2, attackLeft1, guardUp, guardDown, guardLeft, guardRight;
    ...
    public void onCollision(){
        if(this instanceof NPCOldMan){
            changeDirection();
        }
        else if(this instanceof Mon_GreenSlime){
            changeDirection();
        }
        else if(this instanceof Mon_RedSlime){
            changeDirection();
        }
    ...
    public void dropItem(Entity droppedItem){
        for(int i = 0; i < gp.obj[1].length; i++) {
            if(gp.obj[gp.currentMap][i] == null) {
                ...
                gp.obj[gp.currentMap][i].worldX = worldX; // Drop where monster died
    ...
    public void attacking()
    {
        ...
        if(spriteCounter > motion1_duration && spriteCounter <= motion2_duration){
            ...
            //adjust player worldX/Y for attacking Area
            switch(direction){
            ...
            //checking after collision, reset to original data
    ...
    public void damagePlayer(int attack){
        if(gp.player.invisible == false){
            ...
            //get an opposite directionof this attacker
    ...
    public void searchPath(int goalCol, int goalRow){
        ...
        if(gp.pFinder.search() == true){
            ...
            //if path reaches the goal, stop the search
    ...
    public int getDetected(Entity user, Entity target[][], String targetName){
        ...
        switch(user.direction){
            ...
            case "dowm": nextWorldY = user.getBottom() + gp.player.speed; break;
